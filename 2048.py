...
def merge(line):
    ...
    # Result list initialized to zeroes
    result_list = [0] * len(line)

    # Merge Phase 2 Algorithm for 2048, combining tiles
    last_merged = 0
    for elem in range(0, len(line)):
...
class TwentyFortyEight:
    ...
    def __init__(self, grid_height, grid_width):
        ...
        # initiate dictionary for each direction
    ...
    def __str__(self):
        ...
        """
        # returns a string representation of current cells
    ...
    def get_grid_width(self):
        ...
        """
        # given neither are 0, returns grid height
